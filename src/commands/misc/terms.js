...
module.exports = class extends BaseCommand {
    ...
    async run(client, message, args) {
        return message.channel.send(new Discord.MessageEmbed()
            ...
            .setTitle(`Straw Bot - Terms of Service`)
            .setThumbnail(process.env.THUMBNAIL)
            .setDescription('\nStraw has access to the End User Data through the Discord API, but Straw does not collect, use and/or disclose End User Data except (a) as necessary to exercise your rights under this Agreement, (b) in accordance with Discord’s Privacy Policy.' +
                ...
                '\n\nBy using Straw you expressly agree to this Agreement. And by using Discord you expressly agree to Discord’s [Terms of Service](https://discordapp.com/terms), [Guidelines](https://discordapp.com/guidelines) and [Privacy Policy](https://discordapp.com/privacy).' +
